                        ...
                        <WelcomeInner>
                            ...
                            >
                                ...
                                {auth.isAuthenticated() ? (
                                            <Button size="small" color="secondary" variant="contained" onClick={() => auth.logout()} className="log-Button">
                                                Logout
                                            </Button>
                                    ) : (
                                                <Button size="small" color="secondary" variant="contained"  onClick={() => auth.login()} className="log-Button">
                                                    Returning Users
                                                </Button>)};
                            </Grid>
                        </WelcomeInner>    
