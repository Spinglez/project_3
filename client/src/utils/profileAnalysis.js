...
export const profileAnalysis = {
    movieType: surveyResponses => {
        ...
        if (personaArr.length > 1) {
            ...
            else if (personaArr.includes("Hopeless Romantic")) {
            ...
            else if (personaArr.includes("Action Seeker")) {
                if (heartRaceSelection.includes(2) || heartRaceSelection.includes(3)) {
            ...
            else if (personaArr.includes("Lover of Darkness")) {
            ...
            else if (personaArr.includes("Futuristic")) {
            ...
            else if (personaArr.includes("Entertainee")) {
